                                     ...
                                     gpointer *cleanup_data)
{
    ...
    if (iface_cache->g_type == G_TYPE_NONE) {
        ...
        PyObject *py_type = pygi_type_import_by_gi_info (
                             ...
                             GIEnumInfo *iface_info)
{
    ...
    res = pygi_arg_enum_setup_from_info (cache, type_info, arg_info, transfer,
                                         direction);
    if (res) {
        return cache;
    } else {
                              ...
                              GIFlagsInfo *iface_info)
{
    ...
    res = pygi_arg_flags_setup_from_info (cache, type_info, arg_info, transfer,
                                          direction);
    if (res) {
        return cache;
    } else {
