...
_wrap_pyg_enum_add (PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords (args, kwargs, "O!sO!O!:enum_add", kwlist,
...
_wrap_pyg_flags_add (PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords (args, kwargs, "O!sO!O!:flags_add",
                                      kwlist, &PyModule_Type, &module, &name,
                                      &PyGTypeWrapper_Type, &py_g_type,
                                      &PyGIEnumInfo_Type, &py_info)) {
        return NULL;
    }
