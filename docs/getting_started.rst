...
if you are running a 32 bit version of windows, execute the following command
#)``pacman -S mingw-w64-i686-gtk3 mingw-w64-i686-python3-gobject``

if you are running a 64 bit version of windows, execute the following command
